def runProgram():
    ...
    def drukujTablice():
        ...
        print('|       |       |       |')
        print('|  ', stanPola[0], '  |  ',
              stanPola[1], '  |  ', stanPola[2], '  |')
        print('|       |       |       |')
        print('+-------+-------+-------+')
        print('|       |       |       |')
        print('|  ', stanPola[3], '  |  ',
              stanPola[4], '  |  ', stanPola[5], '  |')
        print('|       |       |       |')
        print('+-------+-------+-------+')
        print('|       |       |       |')
        print('|  ', stanPola[6], '  |  ',
              stanPola[7], '  |  ', stanPola[8], '  |')
        print('|       |       |       |')
        print('+-------+-------+-------+')
...
# petla wywołująca funkcję 'While koniec != True
    ...
    while koniec != True:
        ...
        if czyWygralGracz() == True:  # Wywołanie definicji - Sprawdzenie, czy zwyciestwo gracza
            ...
            # Wywołanie definicji - sprawdz czy sa wolne pola, jak nie, to koniec == True
            if czyWszystkiePolaZajete() == True:
